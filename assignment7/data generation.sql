...
create table account (account_number varchar(15) not null unique,branch_name varchar(15) not null,balance int not null,primary key(account_number));

create table branch (branch_name varchar(15) not null unique,branch_city varchar(15) not null,assets int not null,primary key(branch_name));
...
create table loan (loan_number varchar(15) not null unique,branch_name varchar(15) not null,amount int not null,primary key(loan_number));
...
create table employee (employee_name varchar(15) not null unique,branch_name varchar(10) not null,salary int not null,primary key(employee_name, branch_name),foreign key(branch_name) references branch(branch_name));
...
insert into employee values('Brooks', 'Perryridge', 1300);
...
insert into employee values('Williams', 'Downtown', 2500);
insert into employee values('Green', 'Central', 1500);
insert into employee values('Sato', 'Central', 1600);
